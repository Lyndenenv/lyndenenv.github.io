...
// Standard Material 3 type scale. Swapping FontFamily.Default for a loaded
// Google-style font (e.g. "Inter" or "Google Sans Text" via Compose
// multiplatform font resources) is the single biggest lever for matching
// the m3.material.io look and feel -- ask me for that step next.
